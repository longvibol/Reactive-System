...
public class AuthController {
    ...
    @PostMapping("/forgot-pin/otp/confirm")
    public Mono<ForgotPinConfirmOtpResponse> confirmForgotPinOtp(
            @Valid @RequestBody ForgotPinConfirmOtpRequest request
    ) {
        return service.confirmForgotPinOtp(request);
    }
